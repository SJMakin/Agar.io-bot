  ...
  */      
   ...
   */  
        if (this.toggleFollow == true) {
            ...
            var shiftedAngle = this.getAngle(clusterAllFood[bestFoodI][0], clusterAllFood[bestFoodI][1], player[k].x, player[k].y);
